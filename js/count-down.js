...
(function () {
    ...
    CountDown.prototype.getEndTime = function () {
        ...
        var countdownTarget = localStorage.getItem('countdownTaget');    // Read from storage.

        if (countdownTarget === null) {  
            if (this.element.getAttribute('data-timer')) {
                countdownTarget = Number(this.element.getAttribute('data-timer')) * 1000 + new Date().getTime();
            } else if (this.element.getAttribute('data-countdown')) {
                countdownTarget = Number(new Date(this.element.getAttribute('data-countdown')).getTime());
            }                                 // Not stored?
            localStorage.setItem('countdownTaget', countdownTarget);     // Store it.
        }
    ...
    CountDown.prototype.updateCountDown = function (bool) {
        ...
        //alert(this.getTimeFormat(seconds));
    };
